...
SELECT
     ...
     , CASE
         WHEN email_to_address IS NOT NULL
          AND TRIM(email_to_address) != ''
         THEN 'Email'
         ELSE 'Print'
       END                                           invoice_delivery_method
     , TRIM(LOWER(email_to_address))                 invoice_notification_email_recipients
     , CASE
         WHEN email_to_address IS NOT NULL
          AND TRIM(email_to_address) != ''
         THEN 'Email'
     ...
     , TRIM(LOWER(email_to_address))                 statement_notification_email_recipients
     , CASE
         WHEN email_to_address IS NOT NULL
          AND TRIM(email_to_address) != ''
         THEN 'Email'
     ...
     , TRIM(LOWER(email_to_address))                 dunning_letter_notification_email_recipients
