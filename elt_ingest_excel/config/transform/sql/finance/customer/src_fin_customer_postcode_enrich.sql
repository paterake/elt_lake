...
-- Example: Enrich Customer Data with Postcode Mappings
-- This query demonstrates how to join the customer table to the newly loaded postcode reference tables.
