...
SELECT DISTINCT
     ...
     , NULLIF(TRIM(INITCAP(w.legal_name_first_name )), '')                             first_name
     , NULLIF(TRIM(INITCAP(w.legal_name_middle_name)), '')                             middle_name
     , NULLIF(TRIM(INITCAP(w.legal_name_last_name  )), '')                             last_name
